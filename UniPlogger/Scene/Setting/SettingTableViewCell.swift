...
class SettingTableViewCell: UITableViewCell {
  ...
  var infoItem: Setting.SettingType = .autosave
  
  var switchClosure: (_ type: Setting.SettingType, _ isOn: Bool) -> Void = { _, _  in }
  ...
  func configure(item: Setting.SettingType) {
    self.infoItem = item
    itemLabel.text = infoItem.title
